...
export const metadata: Metadata = {
  title: "Help & setup",
  description:
    "BondWell help and setup guidance for linked support, Android device reliability, notifications, battery settings, and calm troubleshooting.",
  alternates: {
    canonical: "/help",
  },
};
    ...
    <main className="min-h-screen bg-white text-[#2F2A26]">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
          <div className="rounded-[2rem] border border-[#E7DED4] bg-white p-8 shadow-sm md:p-10">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-[#2F2A26] md:text-5xl">
              Calm setup help for BondWell
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-[#5A514A]">
              A few simple checks can make BondWell feel much more reliable day to day.
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl space-y-12 px-6 py-14 md:py-16">
          <section>
            <h2 className={sectionTitle}>1. Keep BondWell reliable on Android</h2>
            <p className={bodyText}>
              If reminders are going to feel calm and dependable, your phone needs to let BondWell do its job in the background.
            </p>
            <ul className={bulletList}>
              <li>Turn notifications on for BondWell.</li>
              <li>Set battery usage to unrestricted or allow BondWell to run without battery limits.</li>
          ...
          <section>
            ...
            <p className={bodyText}>
              BondWell Premium is the linked two-phone experience. One phone is the main BondWell account, and the other joins using a BondWell code.
            </p>
            <ul className={bulletList}>
              <li>Secure the main BondWell phone with the correct account email.</li>
              <li>Make sure Premium is active on the main BondWell account.</li>
              <li>Open linked support and create or refresh the BondWell code.</li>
          ...
          <section>
            ...
            <ul className={bulletList}>
              ...
              <li>Make sure the BondWell sound is being used, not just the default phone tone.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 space-y-5 text-base leading-8 text-[#5A514A]">
              <div>
                ...
                <p>Check battery settings, notification permissions, sound settings, and whether your phone has replaced BondWell’s channel sound with a default tone.</p>
              </div>
              <div>
                <p className="font-semibold text-[#2F2A26]">The linked phone is not updating</p>
                <p>Open the app on both phones, check the internet connection, and confirm the phones are still linked in BondWell.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>Use the unlink option in BondWell linked support. That is the clear stop-sharing route for the two-phone experience.</p>
              </div>
            </div>
          </section>
